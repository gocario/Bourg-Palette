 ...
 * @version 1.0
 */
public abstract class TupleAbstractAlgorithm implements IAlgorithm<ColorImage>
{
	...
	protected TupleAbstractAlgorithm(List<ColorImage> inputImages)
	{
	...
	protected TupleAbstractAlgorithm(ColorImage... inputImages)
	{
